<template>
    <div ref="form" class="a-news-panel container needs-validation" novalidate>
        <div class="row mt-5">
            <div class="col-md-7">
                <block class="h-100">
                ...
                <block>
                    <div class="form-group">
                        ...
                        <text-editor
                            ...
                            :initial="
                                this.initial ? this.initial.content : null
                            "
                        />
                    </div>
                </block>
        ...
        <div class="row mt-4 pb-5">
            <div class="col-12">
                <block>
                    <button class="btn btn-primary" @click.prevent="sendNews">
...
export default {
    ...
    methods: {
        ...
        checkSlug: function(slug) {
            ...
            this.$http
                .post("/api/admin/news/check-slug", data)
                .then(response => {
        ...
        sendNews: function() {
            ...
            data.append(
                "published_at",
                moment(this.published_at).format("YYYY-MM-DD")
            );
            ...
            if (this.isEdit == true) {
                ...
                data.append("file", this.file);
                this.$http
                    .post("/api/admin/news/create", data)
                    .then(response => {

...
<div class="competenze">
    ...
    <div
        class="competenze-content collapse"
        ref="content"
        v-html="content"
    >
    </div>
    <div class="competenze-footer">
